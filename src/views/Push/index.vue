          ...
          <div class="detail">
            <div class="top">
              <el-input
                ...
                :style="{ width: '50%' }"
              />
              <el-button size="small" type="primary" @click="confirmRoomName"> 确定 </el-button>
            </div>
            <div class="bottom">
    ...
    <div class="right">
      ...
      <div class="danmu-card">
        ...
        <div class="send-msg">
          ...
          <n-button type="info" size="small" @click="sendMessage"> 发送 </n-button>
        </div>
      </div>
    </div>
  </div>
...
watch(chatList, () => nextTick(() => (chatRef.value!.scrollTop = chatRef.value?.scrollHeight!)), {
  deep: true
})
</script>
