        ...
        <div class="wplayer-control-box" :class="mobile ? 'wplayer-control-box-mobile' : ''">
            ...
            <div class="control-left">
                ...
                <span class="time-text">
                    <span v-if="!isFinite(videoInfo.duration)">{{ toTimeText(videoInfo.currentTime) }}</span>
                    <span v-else>{{ toTimeText(videoInfo.currentTime) }} / {{ toTimeText(videoInfo.duration) }}</span>
                </span>
            </div>
            <!--控制栏中(全屏状态下的弹幕发送区)-->
...
import type { QualityType } from '@/types/barrage';
